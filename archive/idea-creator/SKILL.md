...
- **VENUE = `NeurIPS`** — Target venue for idea framing. Override: `/idea-creator "topic" — venue: nature-communications`. Determines the researcher persona and evaluation framing.
...
2. **Critical review**: Use GPT-5.4 via `mcp__codex__codex-reply` (same thread):
   ...
   - How would you rank these for a [VENUE] submission?
