...
- **VENUE = `NeurIPS`** — Target venue for reviewer framing. Override: `/auto-paper-improvement-loop "paper/" — venue: nature-communications`. Determines the reviewer persona and evaluation criteria.
