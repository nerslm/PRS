...
- **MAX_PAGES** — Main body page limit. Default venue is PRL (4 journal pages ≈ 3750 words). ICLR=9, NeurIPS=9, ICML=8, NatureComms ≈ no strict limit (aim 8-10), PRL=4 journal pages total (includes references).
